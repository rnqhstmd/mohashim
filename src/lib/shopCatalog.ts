...
export const CATALOG: ShopItem[] = [
  ...
  { id: "face_heart_glasses", slot: "face", nameKo: "불타는 눈빛",       price: 40,  svgPath: faceHeartGlassesSvg },
  { id: "face_square_horn",   slot: "face", nameKo: "멋쟁이 선글라스",   price: 60,  svgPath: faceSquareHornSvg },
  { id: "head_strawhat",      slot: "head", nameKo: "새싹 핀",           price: 100, svgPath: headStrawhatSvg },
  { id: "head_beret_red",     slot: "head", nameKo: "노란 안전모",       price: 120, svgPath: headBeretRedSvg },
  { id: "head_wizard_cone",   slot: "head", nameKo: "마법사 고깔",       price: 150, svgPath: headWizardConeSvg },
  { id: "back_blanket_check", slot: "back", nameKo: "포근한 담요 망토",  price: 200, svgPath: backBlanketCheckSvg },
  { id: "back_cloak_navy",    slot: "back", nameKo: "빨간 히어로 망토",  price: 250, svgPath: backCloakNavySvg },
  { id: "back_cloak_aura",    slot: "back", nameKo: "반짝이는 오라",     price: 300, svgPath: backCloakAuraSvg },
];
