...
export const CATALOG: ShopItem[] = [
  { id: "face_round_glasses", slot: "face", nameKo: "동글 안경",             price: 30,  svgPath: faceRoundGlassesSvg },
  { id: "face_heart_glasses", slot: "face", nameKo: "불타는 안경",            price: 40,  svgPath: faceHeartGlassesSvg },
  { id: "face_square_horn",   slot: "face", nameKo: "멋쟁이 선글라스",        price: 60,  svgPath: faceSquareHornSvg },
  { id: "head_strawhat",      slot: "head", nameKo: "밀짚모자",               price: 100, svgPath: headStrawhatSvg },
  { id: "head_beret_red",     slot: "head", nameKo: "예술가 모자",            price: 120, svgPath: headBeretRedSvg },
  { id: "head_wizard_cone",   slot: "head", nameKo: "마법사 고깔",            price: 150, svgPath: headWizardConeSvg },
  { id: "back_blanket_check", slot: "back", nameKo: "포근한 담요 목도리",     price: 200, svgPath: backBlanketCheckSvg },
  { id: "back_cloak_navy",    slot: "back", nameKo: "빨간 히어로 목도리",     price: 250, svgPath: backCloakNavySvg },
  { id: "back_cloak_aura",    slot: "back", nameKo: "반짝이는 오라 목도리",   price: 300, svgPath: backCloakAuraSvg },
];
