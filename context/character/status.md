...
| FR-20 | 멘트 8 버킷 무작위 노출 (idle/focusHigh/focusLow/focusBroken/break/sessionComplete/noiseLoud/discarded) | ✅ | [PR #3](https://github.com/rnqhstmd/mohashim/pull/3) + [PR #11](https://github.com/rnqhstmd/mohashim/pull/11). seed 기반 회전 + NaN/Infinity 폴백 + 빈 배열 가드. PR #11 — ANALYSIS.md §6 확정 문안으로 5버킷(idle 7/break 5/sessionComplete 4/noiseLoud 3 전체교체/discarded 3 전체교체) 갱신. focusHigh/focusLow/focusBroken 불변 (BR-2) |
