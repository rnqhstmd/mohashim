...
<!--
  스크린샷 섹션 — 실제 앱 스크린샷으로 교체해 주세요.
  권장: docs/screenshots/ 폴더에 이미지를 추가하고 아래 img 태그를 업데이트하세요.
-->

<div align="center">

*스크린샷 준비 중입니다 — 곧 업데이트됩니다.*

<!--
<img src="docs/screenshots/main.png" alt="메인 화면" width="320"/>
<img src="docs/screenshots/focused.png" alt="집중 모드" width="320"/>
-->
...
한 달 잔디 그래프를 1080×1080 PNG으로 합성해 클립보드에 복사합니다. 가장 집중 잘 한 날, 할일 가장 많이 한 날 등 베스트 통계도 함께 담깁니다.
